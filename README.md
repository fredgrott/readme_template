...
[![HitCount](http://hits.dwyl.com/fredgrott/readme_template.svg)](http://hits.dwyl.com/fredgrott/readme_template)
...
This project is part of larger collection called:
...
These prerequisites need to be installed before the Flutter SDK:

-[Git](https://git-scm.com/)

At least one SDk target. At March 2021 the Flutter SDK requires at least one mobile SDK installed:
...
These are the Dart Binaries that need to installed for my flutter projects:
...
I'm the crazy one that is starting to teach Flutter App development during the COVID-pandemic. The first Flutter App development book in my Flutter-Deep-Dive series is being published in fall of 2021. My Flutter Development articles are published at:
...
-[MS Windows PowerShell, Trevor Sullivan's cheatsheet](https://gist.github.com/pcgeek86/336e08d1a09e3dd1a8f0a30a9fe61c8a)
